...
/*
 * Estas reglas estaban duplicadas en EmpresaForm y UsuarioForm. Ahora que son
 * una sola pieza compartida, se prueban aquí de forma directa: si alguien afina
 * una regla, se ve de inmediato qué deja de aceptar en los dos formularios a la
 * vez, en lugar de descubrirlo por un formulario que rechaza datos válidos.
 */
...
describe('esUrlValida', () => {
  ...
  it('rechaza esquemas peligrosos y URLs incompletas', () => {
    // El motivo de comprobar el protocolo: en un enlace, estos se ejecutan.
