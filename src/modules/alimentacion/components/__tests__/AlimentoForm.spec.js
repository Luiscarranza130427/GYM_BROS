...
describe('AlimentoForm', () => {
  ...
  it('no ofrece controles de estado ni de unidad', async () => {
    // La tabla `alimentos` no tiene columna de estado, y la unidad la deriva el
    // backend del tipo: cualquiera de los dos sería un control decorativo.
    const wrapper = montar()
