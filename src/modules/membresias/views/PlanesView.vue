...
<template>
  <section class="planes-view">
    <PageHeader
      titulo="Planes"
      descripcion="Configura las ofertas comerciales y membresías disponibles para las empresas."
      seccion="Planes"
      :ruta-seccion="{ name: 'planes-listado' }"
      etiqueta="Gestión comercial"
    >
      <template #acciones>
        <RouterLink class="btn btn-primary planes__nuevo" :to="{ name: 'plan-nuevo' }">
