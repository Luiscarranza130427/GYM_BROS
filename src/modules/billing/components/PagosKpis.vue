<script setup>
import { Calendar, CreditCard, DollarSign, TrendingUp } from 'lucide-vue-next'
...
const itemsKpi = computed(() => [
  ...
  },
  {
    ...
    valor: formatearMonto(props.metricas?.ticketPromedio),
    detalle: 'Ingreso medio por transacción',
    icono: TrendingUp,
  ...
  {
    id: 'meses',
    titulo: 'Meses Vendidos',
    valor: (props.metricas?.totalMeses || 0).toLocaleString('es-PE'),
    detalle: 'Meses totales de suscripción',
    icono: Calendar,
