/**
 * Datos simulados del resumen administrativo.
 *
 * La constante permanece privada para impedir que la interfaz pueda acoplarse
 * al mock o modificar la fuente compartida por accidente.
 */
const RESUMEN_DASHBOARD = {
  banner: {
    titulo: 'Gestiona tu gimnasio desde un solo lugar',
    descripcion: 'Supervisa usuarios, rutinas, progreso y actividad reciente desde Gym Bros.',
    accion: {
      texto: 'Ver usuarios',
    },
  },
...
/** Simula GET /dashboard con una latencia suficiente para comprobar el loading. */
