...
function buscarEmpresa(id) {
  ...
  if (!empresa) {
    throw new HttpError({ status: 404, message: 'La empresa solicitada no existe.' })
  }
...
/** Simula DELETE /empresas/:id como una desactivación lógica. */
