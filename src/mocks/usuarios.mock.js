...
function buscarUsuario(id) {
  ...
  if (!usuario) {
    throw new HttpError({ status: 404, message: 'El usuario solicitado no existe.' })
  }
  return usuario
}
...
/** Hace que la siguiente operación mock falle. Útil para probar estados de error sin valores mágicos. */
...
/** Restaura los fixtures; destinada a pruebas aisladas y desarrollo. */
...
/** Simula GET /usuarios con búsqueda, filtros combinables y paginación. */
...
/** Simula DELETE /usuarios/:id mediante desactivación lógica. */
...
/** Simula GET /usuarios/:id/historial. */
